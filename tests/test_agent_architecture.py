...
class TestModuleIntegrity:
    ...
    def test_agent_module_imports(self):
        ...
        try:
            ...
            pytest.fail(f"agent.py failed to import: {exc}")
    ...
    def test_run_module_valid_syntax(self):
        ...
        try:
            ...
            pytest.fail(f"run.py has syntax error: {exc}")
...
class TestSubtaskTerminology:
    ...
    def test_implementation_plan_uses_subtask_class(self):
        ...
        impl_plan_path = (
            Path(__file__).parent.parent / "apps" / "backend" / "implementation_plan" / "main.py"
        )
        ...
        for method_name in dir(instance):
            if method_name.startswith("test_"):
                ...
                try:
                    ...
                    print(f"  ✗ {method_name}: Unexpected error: {exc}")
                    failed += 1
